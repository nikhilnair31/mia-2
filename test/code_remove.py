...
input = """
i have this for the js 
enddocument.addEventListener('DOMContentLoaded', function() {
...
def remove_code_blocks(text, min_lines=3):
    """
    Removes code blocks from the input text.
    
    - Removes triple backtick code blocks.
    - Removes indented code blocks (4+ spaces or tab).
    - Optionally removes code-like lines if there are >= min_lines grouped together.
    """
    
    # Remove triple-backtick blocks
    text = re.sub(r'```(?:.|\n)*?```', '', text)
    
    # Remove indented blocks (4 spaces or tab)
